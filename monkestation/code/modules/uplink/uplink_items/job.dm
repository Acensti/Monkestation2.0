...
/datum/uplink_item/role_restricted/clonekit
	...
	restricted_roles = list(JOB_GENETICIST, JOB_BIOENGINEER, JOB_RESEARCH_DIRECTOR, JOB_MEDICAL_DOCTOR, JOB_CHIEF_MEDICAL_OFFICER, JOB_CARGO_TECHNICIAN, JOB_QUARTERMASTER) // Experimental cloners were traditionally bought by cargo.
