...
/datum/objective_item/steal/hdd_extraction
	...
	excludefromjob = list(JOB_RESEARCH_DIRECTOR, JOB_SCIENTIST, JOB_ROBOTICIST, JOB_GENETICIST, JOB_BIOENGINEER)
...
/datum/objective_item/steal/traitor/rpd
	...
	excludefromjob = list(JOB_ATMOSPHERIC_TECHNICIAN, JOB_STATION_ENGINEER, JOB_CHIEF_ENGINEER, JOB_SCIENTIST, JOB_RESEARCH_DIRECTOR, JOB_GENETICIST, JOB_BIOENGINEER, JOB_ROBOTICIST)
	item_owner = list(JOB_CHIEF_ENGINEER)
	exists_on_map = TRUE
